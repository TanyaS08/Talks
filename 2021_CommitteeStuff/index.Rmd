...
+ Networks contain information and we know that they are predictable
+ We also know that they are important for ecosystem functioning but they aren't considered a 'priority'

*Tackling this*

I sort of the 'deliverables' as either very conceptual/synthesis type things or a very practical thing like the Canadian metaweb
...
+ How do we integrate space and time into our predictions: a horizon scan.

+ **Deliverable:** Pending reviewer feedback
...
+ *Featuring some members of The Fellowship and The Rohirrim*
...
+ Ties in with pt. 2 of `Project One Ring` - gets to claim the end product though...
...
+ Essentially can we say: European Metaweb + AI = Canadian Metaweb
  + Maybe with a bit of phone a friend every now and then
...
+ Involving partial derivatives, language trees and SoCal
...
+ What can we learn from the information that networks contain?
+ Their complexity?
...
+ Turns out they are very complex - *i.e.* Rule #1 (or was it 2?) has been displaced
